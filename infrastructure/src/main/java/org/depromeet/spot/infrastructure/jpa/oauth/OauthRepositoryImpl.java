...
public class OauthRepositoryImpl implements OauthRepository {
    ...
    @Value("${oauth.kakaoRedirectUrl}")
    private String KAKAO_REDIRECT_URL;

    @Value("${oauth.googleRedirectUrl}")
    ...
    @Value("${oauth.kakaoAuthTokenUrlHost}")
    private String KAKAO_AUTH_TOKEN_URL_HOST;

    @Value("${oauth.googleAuthTokenUrlHost}")
    private String GOOGLE_AUTH_TOKEN_URL_HOST;

    // 엑세스 토큰으로 카카오에서 유저 정보 받아오기
    @Value("${oauth.kakaoAuthUserUrlHost}")
    private String KAKAO_AUTH_USER_URL_HOST;

    @Value("${oauth.googleUserUrlHost}")
    private String GOOGLE_AUTH_USER_URL_HOST;
    ...
    public KakaoUserInfoEntity getKakaoUserInfo(String accessToken) {
        KakaoUserInfoEntity userInfo =
                WebClient.create(KAKAO_AUTH_USER_URL_HOST)
                        .get()
                        .uri(
                                uriBuilder ->
